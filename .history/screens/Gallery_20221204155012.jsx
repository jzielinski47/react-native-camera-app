...
export default function Gallery() {
    ...
    const downloadAlbum = async () => {
        ...
        const photos = await MediaLibrary.getAssetsAsync({ album: album, sortBy: "creationTime", first: 1000, mediaType: ["photo"], })
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.gallery}>
                ...
                <FlatList numColumns={6} key={6} data={imageGallery} renderItem={({ item }) => (
