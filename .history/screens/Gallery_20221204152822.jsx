...
export default function Gallery() {
    ...
    const requestPermission = async () => {
        ...
        status !== 'granted' ? alert('brak uprawnień do czytania image-ów z galerii') : null
        const album = await MediaLibrary.getAlbumAsync("DCIM");
        const photos = await MediaLibrary.getAssetsAsync({ first: 100, mediaType: 'photo' })
        alert(JSON.stringify(photos.assets))
    }
