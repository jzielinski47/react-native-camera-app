...
export default function Gallery() {
    ...
    const downloadAlbum = async () => {
        ...
        const photos = await MediaLibrary.getAssetsAsync({ album: album, sortBy: "creationTime", first: 400, mediaType: ["photo"], })
...
const styles = StyleSheet.create({
    ...
    gallery: { flex: 1, justifyContent: 'flex-start', alignItems: 'center', backgroundColor: '#1E1E1E', marginTop: '5%', padding: 10, borderRadius: 15 },
